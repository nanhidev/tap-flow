...
public void the_user_comparies_the_summary_metrics_with_the_detailed_candidate_data() {
...
public void the_user_is_on_the_event_page() {
viewEventReportPage.navigateToEventPage();
}
@And("the user verifies the report button is visible")
public void the_user_verifies_the_report_button_is_visible() {
viewEventReportPage.isReportButtonVisible(), "Report button is not visible on the event card.";
}
}