...
searchEventsPage.areEventRecordsDisplayed();
}
...
searchEventsPage.areRelevantDetailsIncluded();
}
...
searchEventsPage.areEventRecordsDisplayedForKeywords();
}
...
searchEventsPage.areEventRecordsDisplayedCaseInsensitive();
}
...
searchEventsPage.isKeywordRetainedAfterBack(keyword);
}
...
searchEventsPage.isFullListVisibleBeforeSearch();
}
...
searchEventsPage.isResultsLimitedPerPage();
}
...
searchEventsPage.areRecordsDetailsRelevant();
}
...
searchEventsPage.areRecordsRelevantToRole();
}
...
searchEventsPage.areRecordsDisplayedForSpecialCharacters();
}
}