...
public void the_user_clicks_on_the_sorting_option(String sorting_option) {
searchEventsPage.clickSortingOption(sorting_option);
}
...
@Given("the user can return to the first page of results")
public void the_user_can_return_to_the_first_page_of_results() {
searchEventsPage.navigateToFirstPage();
}
...
searchEventsPage.enterKeywordMatchingLargeRecords();
}
...
searchEventsPage.isKeywordsRetainedForReference();
}
...
searchEventsPage.areResultsRelevantToKeywords();
}
...
// DUPLICATE: searchEventsPage.isFullListDisplayed();
// DUPLICATE: }
