...
viewJobEventsPage.areEventsDisplayedConsistently();
}
...
viewJobEventsPage.isLoadingIndicatorDisappeared();
}
...
viewJobEventsPage.isEventsPageDisplayedCorrectly();
}
...
@Then("observes the events page reload")
public void observes_the_events_page_reload() {
...
viewJobEventsPage.isEventsPageLoadedSuccessfully();
}
@When("clicks the refresh button on the browser")
public void clicks_the_refresh_button_on_the_browser() {
