...
loginScreenForRecruitersPage.isUserLoggedIn(browser);
}
...
public void the_user_confirms_password_in_the_confirm_password_field(String newPassword) {
...
loginScreenForRecruitersPage.isUserLoggedInWithNewPassword();
}

@Given("the dashboard should load successfully")
public void the_dashboard_should_load_successfully() {
loginScreenForRecruiters.verifyDashboardLoaded();
}
@When("the user logs in successfully on desktop")
public void the_user_logs_in_successfully_on_desktop() {
loginScreenForRecruiters.loginOnDesktop();
}
@When("i log in")
public void i_log_in() {
loginScreenForRecruiters.performLogin();
}
@Then("the user confirms {string}")
public void the_user_confirms(String confirmationMessage) {
Assert.assertEquals(confirmationMessage, loginScreenForRecruiters.getConfirmationMessage());
}
@Then("the user is redirected to the login page")
public void the_user_is_redirected_to_the_login_page() {
loginScreenForRecruiters.isLoginPageDisplayed();
}
...
loginScreenForRecruiters.isLoggedInSuccessfully(browser);
}
...
loginScreenForRecruiters.enterCredentials(username, password);
}
