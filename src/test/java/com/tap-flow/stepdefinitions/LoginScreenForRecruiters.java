...
loginScreenForRecruitersPage.isUserLoggedInSuccessfully(browser);
}
...
loginScreenForRecruitersPage.isUserLoggedInSuccessfullyWithNewPassword();
}
...
@Given("the user enters {string} {string}")
public void the_user_enters(String username, String password) {
loginScreenForRecruitersPage.enterCredentials(username, password);
}
...
loginScreenForRecruitersPage.clicksLoginButton();
}
...
loginScreenForRecruitersPage.clicksShowHidePasswordOption();
}
...
loginScreenForRecruitersPage.isUserOnDashboard();
}
...
loginScreenForRecruitersPage.enterUsername(username);
}
